...
public class AltaYconsulta extends JFrame {
  ...
  public AltaYconsulta() {
    ...
    JLabel lblDescripcinDelArtculo = new JLabel("Descripci髇 del art韈ulo:");
    ...
    btnConsultaPorCdigo = new JButton("Consulta por c骴igo");
      ...
      public void actionPerformed(ActionEvent arg0) {
        ...
        try {
          ...
          if (registro.next()==true) {
            ...
            labelResultado.setText("No existe un art韈ulo con dicho c贸digo");
          }
          conexion.close();
        } catch(SQLException ex){
          setTitle(ex.toString());
    ...
    lblIngreseCdigoDe = new JLabel("Ingrese c骴igo de articulo a consultar:");
      ...
      public void actionPerformed(ActionEvent arg0) {
        ...
        try {
          ...
          if (cantidad==1) {
            tf1.setText("");
            tf2.setText("");        
            labelResultado.setText("Se borro el art铆culo con dicho c贸digo");
          } else {
            labelResultado.setText("No existe un art铆culo con dicho c贸digo");
          }
          conexion.close();
        } catch(SQLException ex){
          setTitle(ex.toString());
    ...
    btnNewButton_1.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        try {
          ...
          if (cantidad==1) {
            labelResultado.setText("Se modifico la descripcion y el precio del art铆culo con dicho c贸digo");
          } else {
            labelResultado.setText("No existe un art韈ulo con dicho c骴igo");
          }
          conexion.close();
        } catch(SQLException ex){
          setTitle(ex.toString());
